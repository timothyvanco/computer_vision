...
class ExampleApp(tk.Tk):
    def __init__(self):
        ...
        self.canvas = tk.Canvas(self, width=self.width_box, height=self.height_box, cursor="cross", bg="black")
    ...
    def compute_vector(self, obj_x0, obj_y0, obj_x1, obj_y1, box_width, box_height):
        ...
        alpha = math.asin(a / c)  # angle of vector from center of object into center of box
        ...
        if center_object_x >= (box_width / 2):
            if center_object_y <= (box_height / 2):
                ...
                y = center_object_y + a_vector
                x = center_object_x - b_vector
